...
<div class="blog_header">
	...
	<div class="blog_header_bottom container"><!--这里设置轮播大图，记得前两个都是设置了浮动，所以lunbo样式必须设置清除浮动	-->	
    ...
    <div class="container">
		...
		<div class="blog_content_content">
			...
			<div class="panel panel-success  clear blog_content_content_blog">
				<div class="panel-heading">最新文章 <div class="float_right"><a href="classify.asp?action=newest">more</a></div></div>
				<%
		...
		'				read_time=rs("read_time")
				...
				<div class="media">
					...
					<div class="media-body" >
						 ...
						 <li>分类（<a href="classify.asp?action=classify&classify_name=<%=rs("classify_name")%>"><%=rs("classify_name")%></a>）</li>
			...
			<!--第三部分，最热文章-->
			<div class="panel panel-success  clear blog_content_content_blog">
				<div class="panel-heading">最热文章<div class="float_right"><a href="classify.asp?action=hottest">more</a></div></div>
				<% 
